...
CUSTSEGMMATRICE_LST <- 
  list(RECENCY = matrix(c(1, 0, 5,
                          2, 3, 4,
                          3, 4, 3,
                          4, 11, 2,
                          5, 16, 1), nrow = rfmRecencyClusters, ncol = 3, byrow = TRUE),
       FREQUENCY = matrix(c(1, 1, 1,
                            2, 2, 2,
                            3, 3, 3,
                            4, 5, 4,
                            5, 8, 5), nrow = rfmFrequencyClusters, ncol = 3,  byrow = TRUE),
       MONETARY = matrix(c(1, 250, 1,
                           2, 500, 2,
                           3, 750, 3,
                           4, 1250, 4,
                           5, 2000, 5), nrow = rfmMonetaryClusters,  ncol = 3,  byrow = TRUE))
...
rfmtcScoredDF <- calculatePB_RespProb(rfmtcScoredDF, m = 4)
